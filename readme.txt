...
install mocha -npm install -save-dev mocha@5.2.0 (this can be replaced by cucumber https://github.com/webdriverio/cucumber-boilerplate)
...
run individual tests: npm test -- --spec=tests/ajaxClickTest.js
